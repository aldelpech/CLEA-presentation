...
if (!class_exists('clea_presentation_AdminPageFramework_Registry', false)):
    abstract class clea_presentation_AdminPageFramework_Registry_Base {
        const VERSION = '3.8.1';
    ...
    final class clea_presentation_AdminPageFramework_Registry extends clea_presentation_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['clea_presentation_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['clea_presentation_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('clea_presentation_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['clea_presentation_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('clea_presentation_AdminPageFramework_Bootstrap', false)):
    final class clea_presentation_AdminPageFramework_Bootstrap {
        static private $_bLoaded = false;
        public function __construct($sLibraryPath) {
            if (!$this->_isLoadable()) {
                return;
            }
            clea_presentation_AdminPageFramework_Registry::setUp($sLibraryPath);
            if (clea_presentation_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                return;
            }
            $this->_include();
        }
        ...
        private function _include() {
            include (clea_presentation_AdminPageFramework_Registry::$sAutoLoaderPath);
            new clea_presentation_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('clea_presentation_AdminPageFramework_MinifiedVersionHeader', 'clea_presentation_AdminPageFramework_BeautifiedVersionHeader',),), clea_presentation_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new clea_presentation_AdminPageFramework_Utility;
                new clea_presentation_AdminPageFramework_WPUtility;
            }
        }
        static private $_bXDebug;
    }
    new clea_presentation_AdminPageFramework_Bootstrap(__FILE__);
endif;
