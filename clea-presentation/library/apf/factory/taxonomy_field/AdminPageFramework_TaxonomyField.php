...
abstract class clea_presentation_AdminPageFramework_TaxonomyField_Router extends clea_presentation_AdminPageFramework_Factory {
...
abstract class clea_presentation_AdminPageFramework_TaxonomyField_Model extends clea_presentation_AdminPageFramework_TaxonomyField_Router {
...
abstract class clea_presentation_AdminPageFramework_TaxonomyField_View extends clea_presentation_AdminPageFramework_TaxonomyField_Model {
...
abstract class clea_presentation_AdminPageFramework_TaxonomyField_Controller extends clea_presentation_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class clea_presentation_AdminPageFramework_TaxonomyField extends clea_presentation_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
