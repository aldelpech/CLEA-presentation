...
class clea_presentation_AdminPageFramework_Property_widget extends clea_presentation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation', $sStructureType) {
