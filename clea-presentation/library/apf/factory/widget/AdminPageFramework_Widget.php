...
abstract class clea_presentation_AdminPageFramework_Widget_Router extends clea_presentation_AdminPageFramework_Factory {
...
abstract class clea_presentation_AdminPageFramework_Widget_Model extends clea_presentation_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new clea_presentation_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class clea_presentation_AdminPageFramework_Widget_View extends clea_presentation_AdminPageFramework_Widget_Model {
...
abstract class clea_presentation_AdminPageFramework_Widget_Controller extends clea_presentation_AdminPageFramework_Widget_View {
...
abstract class clea_presentation_AdminPageFramework_Widget extends clea_presentation_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'clea-presentation') {
