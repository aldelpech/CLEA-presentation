...
abstract class clea_presentation_AdminPageFramework_UserMeta_Router extends clea_presentation_AdminPageFramework_Factory {
...
abstract class clea_presentation_AdminPageFramework_UserMeta_Model extends clea_presentation_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new clea_presentation_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class clea_presentation_AdminPageFramework_UserMeta_View extends clea_presentation_AdminPageFramework_UserMeta_Model {
...
abstract class clea_presentation_AdminPageFramework_UserMeta_Controller extends clea_presentation_AdminPageFramework_UserMeta_View {
...
abstract class clea_presentation_AdminPageFramework_UserMeta extends clea_presentation_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'clea-presentation') {
