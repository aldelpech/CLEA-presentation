...
abstract class clea_presentation_AdminPageFramework_Input_Base extends clea_presentation_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'clea-presentation-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'clea-presentation-input-label-string',),);
...
class clea_presentation_AdminPageFramework_Input_checkbox extends clea_presentation_AdminPageFramework_Input_Base {
    public function get() {
