...
class clea_presentation_AdminPageFramework_Form_Model___FormatSectionset extends clea_presentation_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new clea_presentation_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
