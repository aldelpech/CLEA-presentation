...
class clea_presentation_AdminPageFramework_Form_Model___SetFieldResources extends clea_presentation_AdminPageFramework_Form_Base {
    ...
    private function _setCommon() {
        ...
        self::$_bCalled = true;
        new clea_presentation_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->_setCommonFormInternalCSSRules();
    }
    private function _setCommonFormInternalCSSRules() {
        $_aClassNames = array('clea_presentation_AdminPageFramework_Form_View___CSS_Form', 'clea_presentation_AdminPageFramework_Form_View___CSS_Field', 'clea_presentation_AdminPageFramework_Form_View___CSS_Section', 'clea_presentation_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'clea_presentation_AdminPageFramework_Form_View___CSS_FieldError', 'clea_presentation_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('clea_presentation_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function _setFieldResources(array $aFieldset) {
        ...
        new clea_presentation_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new clea_presentation_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
