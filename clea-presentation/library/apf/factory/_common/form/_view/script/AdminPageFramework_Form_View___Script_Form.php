...
class clea_presentation_AdminPageFramework_Form_View___Script_Form extends clea_presentation_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeclea_presentation_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.clea-presentation-form-loading' ).remove();
        jQuery( '.clea-presentation-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.clea-presentation-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeclea_presentation_AdminPageFrameworkLoadingOutputs();
