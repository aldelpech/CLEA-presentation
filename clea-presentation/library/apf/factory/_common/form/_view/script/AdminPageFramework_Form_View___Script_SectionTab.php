...
class clea_presentation_AdminPageFramework_Form_View___Script_SectionTab extends clea_presentation_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.clea-presentation-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='clea-presentation-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
