...
class clea_presentation_AdminPageFramework_Form_View___Description extends clea_presentation_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'clea-presentation-form-element-description';
