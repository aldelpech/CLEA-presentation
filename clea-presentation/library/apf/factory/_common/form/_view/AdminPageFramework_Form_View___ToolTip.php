...
class clea_presentation_AdminPageFramework_Form_View___ToolTip extends clea_presentation_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return '' . "<a href='{$_sHref}' class='clea-presentation-form-tooltip'>" . $this->_getTipLinkIcon() . "<span class='clea-presentation-form-tooltip-content'>" . $this->_getTipTitle() . $this->_getDescriptions() . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span class='clea-presentation-form-tool-tip-title'>" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span class='clea-presentation-form-tool-tip-description'>" . implode("</span><span class='clea-presentation-form-tool-tip-description'>", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
}
