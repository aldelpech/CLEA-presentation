...
class clea_presentation_AdminPageFramework_Form_View___FieldsetTableRow extends clea_presentation_AdminPageFramework_Form_View___Section_Base {
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new clea_presentation_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
    ...
    private function _getFieldTitle(array $aField) {
        $_oInputTagIDGenerator = new clea_presentation_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
        return "<label class='clea-presentation-field-title' for='" . $_oInputTagIDGenerator->get() . "'>" . "<a id='{$aField['field_id']}'></a>" . "<span title='" . esc_attr(strip_tags(is_array($aField['description']) ? implode('&#10;', $aField['description']) : $aField['description'])) . "'>" . $aField['title'] . $this->_getTitleColon($aField) . $this->_getToolTip($aField['tip'], $aField['field_id']) . "</span>" . "</label>";
    }
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new clea_presentation_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
...
class clea_presentation_AdminPageFramework_Form_View___FieldsetRow extends clea_presentation_AdminPageFramework_Form_View___FieldsetTableRow {
    public $aFieldset = array();
    public $aSavedData = array();
    public $aFieldErrors = array();
    public $aFieldTypeDefinitions = array();
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new clea_presentation_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
