...
class clea_presentation_AdminPageFramework_Form_View___FieldTitle extends clea_presentation_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_aLabelAttributes = array('class' => $this->getClassAttribute('clea-presentation-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(),);
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField) {
        ...
        foreach ($aField['content'] as $_aNestedField) {
            ...
            $_oFieldset = new clea_presentation_AdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
