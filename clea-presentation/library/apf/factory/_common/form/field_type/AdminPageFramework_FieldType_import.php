...
class clea_presentation_AdminPageFramework_FieldType_import extends clea_presentation_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".clea-presentation-field-import input {margin-right: 0.5em;}.clea-presentation-field-import label,.form-table td fieldset.clea-presentation-fieldset .clea-presentation-field-import label { display: inline; }";
    }
