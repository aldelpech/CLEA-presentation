...
class clea_presentation_AdminPageFramework_FieldType_image extends clea_presentation_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerclea_presentation_AdminPageFrameworkCallbacks( {   
        /**
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType, iSectionIndex, iFieldIndex ) {
            ...
            switch( iCallType ) {
                ...
                case 1: 
                    ...
                    var _oSectionsContainer     = jQuery( oCloned ).closest( '.clea-presentation-sections' );
                ...
                case 2:
                    ...
                    var _oFieldsContainer   = jQuery( oCloned ).closest( '.clea-presentation-fields' );
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.clea-presentation-field' );
            ...
            setclea_presentation_AdminPageFrameworkImageUploader( 
 ...
 */
setclea_presentation_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfclea_presentation_AdminPageFrameworkSendToEditorImage;
...
var hfclea_presentation_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setclea_presentation_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oclea_presentation_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getclea_presentation_AdminPageFrameworkCustomMediaUploaderSelectObject() : oclea_presentation_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.clea-presentation-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addclea_presentation_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oclea_presentation_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.clea-presentation-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".clea-presentation-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .clea-presentation-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .clea-presentation-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.clea-presentation-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.clea-presentation-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.clea-presentation-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.clea-presentation-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.clea-presentation-field .image_preview {max-width: 600px;}}.clea-presentation-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.clea-presentation-field-image input {margin: 0.5em 0.5em 0.5em 0;}} ";
    }
...
jQuery( document ).ready( function(){     
    setclea_presentation_AdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='clea-presentation-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='clea-presentation-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
class clea_presentation_AdminPageFramework_FieldType_media extends clea_presentation_AdminPageFramework_FieldType_image {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerclea_presentation_AdminPageFrameworkCallbacks( {    
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            setclea_presentation_AdminPageFrameworkMediaUploader( 
    ...
    private function _getScript_MediaUploader($sReferrer) {
        ...
        if (!function_exists('wp_enqueue_media')) {
            return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setclea_presentation_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).click( function() {
                            ...
                            window.original_send_to_editor = window.send_to_editor;
                            window.send_to_editor = hfclea_presentation_AdminPageFrameworkSendToEditorMedia;
                            var fExternalSource = jQuery( this ).attr( 'data-enable_external_source' );
                            tb_show( '{$_sThickBoxTitle}', 'media-upload.php?post_id=1&amp;enable_external_source=' + fExternalSource + '&amp;referrer={$sReferrer}&amp;button_label={$_sThickBoxButtonUseThis}&amp;type=image&amp;TB_iframe=true', false );
                            return false; // do not click the button after the script by returning false.     
                        });    
                    ...
                    var hfclea_presentation_AdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
        ...
        return <<<JAVASCRIPTS
                ...
                setclea_presentation_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).click( function( e ) {
                        ...
                        // Store the original select object in a global variable
                        oclea_presentation_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getclea_presentation_AdminPageFrameworkCustomMediaUploaderSelectObject() : oclea_presentation_AdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            // Restore the original select object.
                            wp.media.view.MediaFrame.Select = oclea_presentation_AdminPageFrameworkOriginalMediaUploaderSelectObject;    
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.clea-presentation-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".clea-presentation-field-media input {margin-right: 0.5em;vertical-align: middle;}@media screen and (max-width: 782px) {.clea-presentation-field-media input {margin: 0.5em 0.5em 0.5em 0;}} .select_media.button.button-small,.remove_media.button.button-small{ vertical-align: middle;}.remove_media.button.button-small {margin-left: 0.2em;}";
    }
    protected function _getPreviewContainer($aField, $sImageURL, $aPreviewAtrributes) {
        return "";
    }
...
jQuery( document ).ready( function(){   
    setclea_presentation_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='clea-presentation-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
