...
class clea_presentation_AdminPageFramework_FieldType_textarea extends clea_presentation_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getclea_presentation_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerclea_presentation_AdminPageFrameworkCallbacks( {				
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType, iSectionIndex, iFieldIndex ) {
            ...
            var _oSettings = jQuery().getclea_presentation_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  

            // Elements
            var _oField              = oCloned.closest( '.clea-presentation-field' );
        ...
        stopped_sorting_fields : function( oSortedFields, sFieldType, sFieldsTagID, iCallType ) { 
            ...
            // Update the editor.
            setTimeout(function(){
                var _oFields = oSortedFields.children( '.clea-presentation-field' );
        ...
        stopped_sorting_sections: function( oSections ) {
            ...
            setTimeout(function(){
                var _oFields = jQuery( oSections ).find( '.clea-presentation-field' );
                updateFoundEditors( _oFields );           
            }, 100 );
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.clea-presentation-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeclea_presentation_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".clea-presentation-field-textarea .clea-presentation-input-label-string {vertical-align: top;margin-top: 2px;} .clea-presentation-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.clea-presentation-field-textarea.clea-presentation-field .clea-presentation-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .clea-presentation-field-textarea .clea-presentation-input-label-container {width: 100%;}.clea-presentation-field-textarea textarea {max-width: 100%;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'clea-presentation-field-textarea-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='clea-presentation-input-label-container {$_sClassSelector}'>", "<label for='" . $aField['attributes']['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'clea-presentation-input-label-string') . ">" . $_sLabel . "</span>" : '', $this->_getEditor($aField), $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='clea-presentation-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
