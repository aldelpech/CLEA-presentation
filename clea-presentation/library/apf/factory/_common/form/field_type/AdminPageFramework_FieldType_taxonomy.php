...
class clea_presentation_AdminPageFramework_FieldType_taxonomy extends clea_presentation_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new clea_presentation_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableclea_presentation_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableclea_presentation_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerclea_presentation_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            enableclea_presentation_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".clea-presentation-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.clea-presentation-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.clea-presentation-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.clea-presentation-field .taxonomy-checklist ul ul {margin-left: 1em;}.clea-presentation-field .taxonomy-checklist-label {white-space: nowrap; }.clea-presentation-field .tab-box-container.categorydiv {max-height: none;}.clea-presentation-field .tab-box-tab-text {display: inline-block;}.clea-presentation-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.clea-presentation-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 2px;background-color: #fff;}.clea-presentation-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.clea-presentation-field .tab-box-tabs li a { color: #333; text-decoration: none; }.clea-presentation-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.clea-presentation-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.clea-presentation-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.clea-presentation-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.clea-presentation-field .tab-box-content:target, .clea-presentation-field .tab-box-content:target, .clea-presentation-field .tab-box-content:target { display: block; }.clea-presentation-field .tab-box-content .select_all_button_container, .clea-presentation-field .tab-box-content .select_none_button_container{margin-top: 0.8em;}.clea-presentation-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
    ...
    private function _getTaxonomyCheckboxes(array $aField, $sKey, $sTaxonomySlug) {
        $_aTabBoxContainerArguments = array('id' => "tab_{$aField['input_id']}_{$sKey}", 'class' => 'tab-box-content', 'style' => $this->generateInlineCSS(array('height' => $this->getLengthSanitized($aField['height']), 'width' => $this->getLengthSanitized($aField['width']),)),);
