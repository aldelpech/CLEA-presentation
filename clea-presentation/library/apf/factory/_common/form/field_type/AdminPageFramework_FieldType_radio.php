...
class clea_presentation_AdminPageFramework_FieldType_radio extends clea_presentation_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".clea-presentation-field input[type='radio'] {margin-right: 0.5em;} .clea-presentation-field-radio .clea-presentation-input-label-container {padding-right: 1em;} .clea-presentation-field-radio .clea-presentation-input-container {display: inline;} .clea-presentation-field-radio .clea-presentation-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.clea-presentation-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
