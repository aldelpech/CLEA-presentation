...
class clea_presentation_AdminPageFramework_FieldType_submit extends clea_presentation_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".clea-presentation-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'clea-presentation-input-label-container' . ' clea-presentation-input-button-container' . ' clea-presentation-input-container',);
    }
...
class clea_presentation_AdminPageFramework_FieldType_export extends clea_presentation_AdminPageFramework_FieldType_submit {
