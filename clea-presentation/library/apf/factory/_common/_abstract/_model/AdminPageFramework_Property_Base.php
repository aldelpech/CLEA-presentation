...
abstract class clea_presentation_AdminPageFramework_Property_Base extends clea_presentation_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'clea-presentation' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aclea_presentation_AdminPageFramework'])) {
            $GLOBALS['aclea_presentation_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => clea_presentation_AdminPageFramework_Registry::NAME, 'sURI' => clea_presentation_AdminPageFramework_Registry::URI, 'sScriptName' => clea_presentation_AdminPageFramework_Registry::NAME, 'sLibraryName' => clea_presentation_AdminPageFramework_Registry::NAME, 'sLibraryURI' => clea_presentation_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => clea_presentation_AdminPageFramework_Registry::getVersion(), 'sDescription' => clea_presentation_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => clea_presentation_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => clea_presentation_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => clea_presentation_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => clea_presentation_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new clea_presentation_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
