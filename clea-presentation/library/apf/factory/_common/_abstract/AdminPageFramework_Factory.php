...
abstract class clea_presentation_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'clea_presentation_AdminPageFramework_Form_', 'oPageLoadInfo' => 'clea_presentation_AdminPageFramework_PageLoadInfo_', 'oResource' => 'clea_presentation_AdminPageFramework_Resource_', 'oHelpPane' => 'clea_presentation_AdminPageFramework_HelpPane_', 'oLink' => 'clea_presentation_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'clea_presentation_AdminPageFramework_Debug', 'oUtil' => 'clea_presentation_AdminPageFramework_FrameworkUtility', 'oMsg' => 'clea_presentation_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(clea_presentation_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
...
abstract class clea_presentation_AdminPageFramework_Factory_Model extends clea_presentation_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class clea_presentation_AdminPageFramework_Factory_View extends clea_presentation_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new clea_presentation_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class clea_presentation_AdminPageFramework_Factory_Controller extends clea_presentation_AdminPageFramework_Factory_View {
...
abstract class clea_presentation_AdminPageFramework_Factory extends clea_presentation_AdminPageFramework_Factory_Controller {
}
