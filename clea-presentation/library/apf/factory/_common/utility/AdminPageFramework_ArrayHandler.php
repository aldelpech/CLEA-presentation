...
class clea_presentation_AdminPageFramework_FrameworkUtility extends clea_presentation_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = clea_presentation_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return clea_presentation_AdminPageFramework_Registry::NAME;
    }
}
class clea_presentation_AdminPageFramework_ArrayHandler extends clea_presentation_AdminPageFramework_FrameworkUtility {
    public $aData = array();
