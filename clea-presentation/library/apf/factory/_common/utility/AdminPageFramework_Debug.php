...
class clea_presentation_AdminPageFramework_Debug extends clea_presentation_AdminPageFramework_FrameworkUtility {
    ...
    static private function _getLogHeadingLine($fCurrentTimeStamp, $nElapsed, $sCallerClass, $sCallerFunction) {
        ...
        $_aOutput = array(date("Y/m/d H:i:s", $_nNow) . '.' . $_nMicroseconds, self::_getFormattedElapsedTime($nElapsed), $_iPageLoadID, clea_presentation_AdminPageFramework_Registry::getVersion(), $sCallerClass . '::' . $sCallerFunction, current_filter(), self::getCurrentURL(),);
    ...
    static public function getAsString($mValue) {
        ...
        $mValue = is_array($mValue) ? self::getSliceByDepth($mValue, 10) : $mValue;
