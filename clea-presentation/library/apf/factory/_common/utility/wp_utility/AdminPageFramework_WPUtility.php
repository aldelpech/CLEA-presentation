...
class clea_presentation_AdminPageFramework_WPUtility_URL extends clea_presentation_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(clea_presentation_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(clea_presentation_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = clea_presentation_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class clea_presentation_AdminPageFramework_WPUtility_HTML extends clea_presentation_AdminPageFramework_WPUtility_URL {
...
class clea_presentation_AdminPageFramework_WPUtility_Page extends clea_presentation_AdminPageFramework_WPUtility_HTML {
...
class clea_presentation_AdminPageFramework_WPUtility_Hook extends clea_presentation_AdminPageFramework_WPUtility_Page {
...
class clea_presentation_AdminPageFramework_WPUtility_File extends clea_presentation_AdminPageFramework_WPUtility_Hook {
...
class clea_presentation_AdminPageFramework_WPUtility_Option extends clea_presentation_AdminPageFramework_WPUtility_File {
...
class clea_presentation_AdminPageFramework_WPUtility_Meta extends clea_presentation_AdminPageFramework_WPUtility_Option {
...
class clea_presentation_AdminPageFramework_WPUtility_SiteInformation extends clea_presentation_AdminPageFramework_WPUtility_Meta {
...
class clea_presentation_AdminPageFramework_WPUtility_SystemInformation extends clea_presentation_AdminPageFramework_WPUtility_SiteInformation {
...
class clea_presentation_AdminPageFramework_WPUtility extends clea_presentation_AdminPageFramework_WPUtility_SystemInformation {
