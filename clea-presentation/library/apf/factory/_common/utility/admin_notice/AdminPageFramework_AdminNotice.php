...
class clea_presentation_AdminPageFramework_AdminNotice extends clea_presentation_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'clea-presentation-settings-notice-message', 'clea-presentation-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new clea_presentation_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
