...
class clea_presentation_AdminPageFramework_AdminNotice___Script extends clea_presentation_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.clea-presentation-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='clea-presentation-admin-notice-animation-container'></div>" );
