...
abstract class clea_presentation_AdminPageFramework_TermMeta_Router extends clea_presentation_AdminPageFramework_TaxonomyField_Controller {
}
abstract class clea_presentation_AdminPageFramework_TermMeta_Model extends clea_presentation_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new clea_presentation_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class clea_presentation_AdminPageFramework_TermMeta_View extends clea_presentation_AdminPageFramework_TermMeta_Model {
...
abstract class clea_presentation_AdminPageFramework_TermMeta_Controller extends clea_presentation_AdminPageFramework_TermMeta_View {
}
abstract class clea_presentation_AdminPageFramework_TermMeta extends clea_presentation_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
