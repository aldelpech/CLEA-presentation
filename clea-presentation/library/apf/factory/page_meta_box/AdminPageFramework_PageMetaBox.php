...
abstract class clea_presentation_AdminPageFramework_PageMetaBox_Router extends clea_presentation_AdminPageFramework_MetaBox_View {
...
abstract class clea_presentation_AdminPageFramework_PageMetaBox_Model extends clea_presentation_AdminPageFramework_PageMetaBox_Router {
...
abstract class clea_presentation_AdminPageFramework_PageMetaBox_View extends clea_presentation_AdminPageFramework_PageMetaBox_Model {
}
abstract class clea_presentation_AdminPageFramework_PageMetaBox_Controller extends clea_presentation_AdminPageFramework_PageMetaBox_View {
...
abstract class clea_presentation_AdminPageFramework_PageMetaBox extends clea_presentation_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
