...
abstract class clea_presentation_AdminPageFramework_MetaBox_Router extends clea_presentation_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'clea-presentation') {
...
abstract class clea_presentation_AdminPageFramework_MetaBox_Model extends clea_presentation_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'clea-presentation') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new clea_presentation_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class clea_presentation_AdminPageFramework_MetaBox_View extends clea_presentation_AdminPageFramework_MetaBox_Model {
...
abstract class clea_presentation_AdminPageFramework_MetaBox_Controller extends clea_presentation_AdminPageFramework_MetaBox_View {
...
abstract class clea_presentation_AdminPageFramework_MetaBox extends clea_presentation_AdminPageFramework_MetaBox_Controller {
