...
class clea_presentation_AdminPageFramework_Property_post_meta_box extends clea_presentation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'clea-presentation', $sStructureType = 'post_meta_box') {
