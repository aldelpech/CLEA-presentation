...
abstract class clea_presentation_AdminPageFramework_Router extends clea_presentation_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'clea_presentation_AdminPageFramework_Property_' . $this->_sStructureType;
...
abstract class clea_presentation_AdminPageFramework_Model_Form extends clea_presentation_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
        ...
        new clea_presentation_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new clea_presentation_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class clea_presentation_AdminPageFramework_View_Form extends clea_presentation_AdminPageFramework_Model_Form {
...
abstract class clea_presentation_AdminPageFramework_Controller_Form extends clea_presentation_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return clea_presentation_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class clea_presentation_AdminPageFramework_Model_Page extends clea_presentation_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new clea_presentation_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class clea_presentation_AdminPageFramework_View_Page extends clea_presentation_AdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new clea_presentation_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new clea_presentation_AdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new clea_presentation_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class clea_presentation_AdminPageFramework_Controller_Page extends clea_presentation_AdminPageFramework_View_Page {
...
abstract class clea_presentation_AdminPageFramework_Model_Menu extends clea_presentation_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new clea_presentation_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class clea_presentation_AdminPageFramework_View_Menu extends clea_presentation_AdminPageFramework_Model_Menu {
}
abstract class clea_presentation_AdminPageFramework_Controller_Menu extends clea_presentation_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new clea_presentation_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new clea_presentation_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class clea_presentation_AdminPageFramework_Model extends clea_presentation_AdminPageFramework_Controller_Menu {
}
abstract class clea_presentation_AdminPageFramework_View extends clea_presentation_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class clea_presentation_AdminPageFramework_Controller extends clea_presentation_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new clea_presentation_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return clea_presentation_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class clea_presentation_AdminPageFramework extends clea_presentation_AdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        parent::__construct($isOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? clea_presentation_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
    }
}
