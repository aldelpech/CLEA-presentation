...
abstract class clea_presentation_AdminPageFramework_Model__FormSubmission_Base extends clea_presentation_AdminPageFramework_FrameworkUtility {
...
class clea_presentation_AdminPageFramework_Model__FormSubmission extends clea_presentation_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new clea_presentation_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new clea_presentation_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
