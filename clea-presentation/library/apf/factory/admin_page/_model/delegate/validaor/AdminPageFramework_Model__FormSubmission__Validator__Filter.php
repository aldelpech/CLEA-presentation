...
class clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Filter extends clea_presentation_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
