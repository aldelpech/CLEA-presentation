...
class clea_presentation_AdminPageFramework_Model__FormSubmission__Validator_Base extends clea_presentation_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class clea_presentation_AdminPageFramework_Model__FormSubmission__Validator extends clea_presentation_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Link', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Import', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Export', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new clea_presentation_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
