...
class clea_presentation_AdminPageFramework_Model_Menu__RegisterMenu extends clea_presentation_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterMenu() {
        ...
        foreach ($this->oFactory->oProp->aPages as & $aSubMenuItem) {
            $_oFormatter = new clea_presentation_AdminPageFramework_Format_SubMenuItem($aSubMenuItem, $this->oFactory, $_iParsedIndex);
