...
class clea_presentation_AdminPageFramework_Property_admin_page extends clea_presentation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'clea-presentation') {
        ...
        $GLOBALS['aclea_presentation_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aclea_presentation_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aclea_presentation_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
