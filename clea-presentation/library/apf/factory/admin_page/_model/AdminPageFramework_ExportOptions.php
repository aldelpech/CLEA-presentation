...
abstract class clea_presentation_AdminPageFramework_CustomSubmitFields extends clea_presentation_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class clea_presentation_AdminPageFramework_ExportOptions extends clea_presentation_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo clea_presentation_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
