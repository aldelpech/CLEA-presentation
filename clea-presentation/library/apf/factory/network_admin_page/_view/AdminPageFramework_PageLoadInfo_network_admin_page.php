...
class clea_presentation_AdminPageFramework_PageLoadInfo_network_admin_page extends clea_presentation_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new clea_presentation_AdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
