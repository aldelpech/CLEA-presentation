...
abstract class clea_presentation_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('clea_presentation_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new clea_presentation_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
