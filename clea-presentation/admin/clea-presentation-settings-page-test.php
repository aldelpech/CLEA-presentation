...
/**
 *
 * Créer un menu de réglages du plugin
 *
 *
...
// le code nécessaire
require_once CLEA_PRES_DIR_PATH . 'src/class.settings-api.php'; 

if ( is_admin() ) {
    new WeDevs_Settings_API();
}


/****
* l'essai (contenu de procedural-example.php 
* sur https://github.com/tareq1988/wordpress-settings-api-class/tree/master/example )
****/
